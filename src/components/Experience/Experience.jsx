...
export const Experience = ({theme}) => {
  return (
    <section className="w-[50rem] flex items-center flex-col gap-4 border-slate-700 dark:border-slate-100">
      <div className="w-[50rem] h-[3rem] flex gap-4 items-end">
      ...
      <div className="w-[50rem] h-[4rem] flex flex-col">
        <h1 className="text-xl font-bold text-slate-600 dark:text-gray-100" >Web develover</h1>
        <p className="text-lg text-slate-600 dark:text-gray-100">Nov 2023 - Present</p>
      </div>
